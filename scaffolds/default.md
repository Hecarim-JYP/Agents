...
| TypeScript/Node | `package.json`, `tsconfig.json` 추가, 테스트는 `tests/` 또는 프레임워크 관례 |
| React/Next.js | 프레임워크 CLI(`create-next-app` 등)가 있으면 그걸 우선 사용하고, 그 위에 CLAUDE.md와 docs/만 추가 |
